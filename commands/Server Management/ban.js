			...
			args: [
				{
					...
					type: "user-commando",
					prompt: {
						start: (msg) => global.translate(msg.author.lang, 'Who would you like to ban?'),
						retry: (msg) => global.translate(msg.author.lang, "That's not something we can ban! Try again.")
					},
				},
				{
					id: "reason",
