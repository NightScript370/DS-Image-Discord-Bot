			...
			args: [
				{
					...
					prompt: {
						start: (msg) => global.lang.getString(msg.author.lang, 'What code would you like to evaluate?'),
						retry: (msg) => global.lang.getString(msg.author.lang, 'That is not something we can evaluate. Try again')
					},
					type: 'string',
					match: "rest"
				},
