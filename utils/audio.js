...
module.exports = {
	...
	play: async (msg, client, data) => {
		...
		data.dispatcher = data.connection.play(await Youtube.play(data.queue[0].url, {filter: 'audioonly', quality: 'highestaudio', highWaterMark: 1<<25}), { type: 'opus', volume: false, highWaterMark: 1 });
