...
export default class rulesCommand extends discordAkairo.Command {
	constructor() {
		super("rules", {
			category: 'Useful',
			aliases: ["rules"],
	...
	async exec(msg, { action, key, guild }) {
		return msg.reply('This is a WIP command, and as such does not work. Please try again later')
