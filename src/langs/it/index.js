const language = {
	...
	// MARK: Hangman command
	"Please wait until the current game of {0} is finished.": "Aspetta che finisca la partita di {0}.",
	"New word: `{0}`": "Nuova parola: `{0}`",
	"You have already guessed those characters. Please pick another character to try again with": "Hai già provato quella lettera. Riprova con un'altra",
	"Congratulations! You have won the game of Hangman": "Congratulazioni! Hai vinto questa partita all'impiccato",
	"Oh well, better luck next time": "Ah bè, sarà per la prossima volta...",
	"The word was {0}": "La parola era {0}",
	"Right guesses ({0})": "Lettere indovinate ({0})",
	"Wrong guesses ({0})": "Lettere sbagliate ({0})",
	"Guessed Attempts": "Tentativi",
	"Remaining Attempts: {0}": "Tentativi rimanenti: {0}",
