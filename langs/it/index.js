module.exports = {
    ...
    "you need to be in a voice channel in order for me to play music": "",
    "You lost perms to connect to the Voice Channel.": "",
    "I can't join. Make sure I have the proper permissions.": "",
    "I can't speak. Make sure I have the proper permissions.": "",
    "Related Music Search": "",
    "Added {0} song(s) to Queue: {1} | Requested by: {2}": "",
    "Added to Queue: {0} | Requested by: {1}": "",
    "**NOW PLAYING**: [{0}]({1}) | Requested by {2}": "",
    "**NEXT**: [{0}]({1}) | Requested by {2}": "",
    "": "",
    "": "",
    "": "",
    "": "",
